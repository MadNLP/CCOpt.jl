...
function NLPModels.jac_lin_structure!(nlp::SimpleNLPModel, rows::AbstractVector{Int}, cols::AbstractVector{Int})
  @lencheck 2 rows cols
  rows .= [1, 1]
  cols .= [1, 2]
  return rows, cols
...
function NLPModels.jac_nln_structure!(nlp::SimpleNLPModel, rows::AbstractVector{Int}, cols::AbstractVector{Int})
  @lencheck 2 rows cols
  rows .= [1, 1]
  cols .= [1, 2]
  return rows, cols
...
function NLPModels.jprod_lin!(nlp::SimpleNLPModel, x::AbstractVector, v::AbstractVector, Jv::AbstractVector)
  @lencheck 2 x v
  @lencheck 1 Jv
...
function NLPModels.jprod_nln!(nlp::SimpleNLPModel, x::AbstractVector, v::AbstractVector, Jv::AbstractVector)
  @lencheck 2 x v
  @lencheck 1 Jv
  increment!(nlp, :neval_jprod)
...
function NLPModels.jtprod_lin!(nlp::SimpleNLPModel, x::AbstractVector, v::AbstractVector, Jtv::AbstractVector)
  @lencheck 2 x Jtv
  @lencheck 1 v
...
function NLPModels.jtprod_nln!(nlp::SimpleNLPModel, x::AbstractVector, v::AbstractVector, Jtv::AbstractVector)
  @lencheck 2 x Jtv
  @lencheck 1 v
  increment!(nlp, :neval_jtprod)
...
function NLPModels.jth_hess_coord!(nlp::SimpleNLPModel, x::AbstractVector, j::Integer, vals::AbstractVector{T}) where {T}
  @lencheck 2 x
  @rangecheck 1 2 j
  @lencheck 2 vals
  if j == 1
...
function NLPModels.jth_hprod!(nlp::SimpleNLPModel, x::AbstractVector, v::AbstractVector, j::Integer, hv::AbstractVector{T}) where {T}
  @lencheck 2 x v hv
  @rangecheck 1 2 j
  if j == 1
    hv .= zero(T)
