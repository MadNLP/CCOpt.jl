function MadNLP.regular!(solver::MadNLPSolver{T, VT, VI, KKTSystem, ScholtesRelaxation, CB, Iterator, IC, KKTVec})
    where {T,
           VT <: AbstractVector{T},
    ...
    while true
        ...
        @trace(solver.logger, "Updating Scholtes relaxation parameter.")
